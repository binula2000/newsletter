...
const SubunitCard: React.FC<SubunitCardProps> = ({ 
  ...
  <Section style={styles.cardSection}>
    <Container style={styles.card}>
      ...
      {/* Wrapper uses paddingTop instead of margin for Outlook Web safety */}
...
const styles: Record<string, React.CSSProperties> = {
  ...
  // Use padding instead of margin for OWA safety
  buttonWrapper: {
    paddingTop: '20px',
  },
  // Restored display: inline-block and added lineHeight
  button: {
